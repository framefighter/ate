                                    ...
                                    Ok(rem) => {
                                        if rem {
                                            ...
                                            request.message(cx.answer(format!(
                                                ...
                                                new_meal, meal_name, new_reference
                                            )));
                                            log::info!(
                                                "Changed url of meal {} to {}",
                                                meal_name,
